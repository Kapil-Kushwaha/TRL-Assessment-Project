...
class TRLApp:
    ...
    def load_questionnaire(self, tech_type):
        ...
        self.responses = [tk.StringVar(value="") for _ in self.questions]
        ...
        for idx, question in enumerate(self.questions):
            ...
            yes_button = tk.Radiobutton(self.questionnaire_frame, text="Yes", variable=self.responses[idx], value="yes", font=("Arial", 10), fg="green", bg="#f0f0f0", selectcolor="#f0f0f0")
            yes_button.pack(anchor='w')

            no_button = tk.Radiobutton(self.questionnaire_frame, text="No", variable=self.responses[idx], value="no", font=("Arial", 10), fg="red", bg="#f0f0f0", selectcolor="#f0f0f0")
    ...
    def get_questions_for_type(self, tech_type):
        ...
        if tech_type == "A product that is manufactured":
            return [
                ...
                "Are components tested under controlled environments?",
                "Have environmental factors been considered in technology",
                ...
                "Has the product undergone certification or regulatory test",
